"""
Django settings for tuciul_fermecat project.
...
SECRET_KEY = 'django-insecure-67@lr9gq8z6cy+og2cfw=m2)lo1+18wr-tg^d$qw&*(&4hdyd('
...
ROOT_URLCONF = 'tuciul_fermecat.urls'
...
WSGI_APPLICATION = 'tuciul_fermecat.wsgi.application'
